...
describe('iac-aks', () => {
  context('template file', () => {
    ...
    context('defines the expected parameters', () => {
      ...
      it('should have 12=4 parameters', () => actual.length.should.be.exactly(14));
      ...
      it('should have a ubuntuOSVersion', () => actual.should.containEql('ubuntuOSVersion'));
      it('should have a customData', () => actual.should.containEql('customData'));
    });
